...
public class CameraController : MonoBehaviour {
	...
	void Update ()
    {
        ...
        transform.eulerAngles = new Vector3(xAngle, xAngle += Input.GetAxis("Mouse Y") * VerticalRotationSpeed * Time.deltaTime;
        xAngle = Mathf.Clamp(xAngle, minAngle, maxAngle);, 0.0f);
    }
