Shader "Casey/CelShadingTerrain" 
{
	...
	SubShader{
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			half4 norm0 = tex2D(_Normal0, IN.uv_Normal0);
			half4 norm1 = tex2D(_Normal1, IN.uv_Normal0);
			half4 norm2 = tex2D(_Normal2, IN.uv_Normal0);
			half4 norm3 = tex2D(_Normal3, IN.uv_Normal0);
