Shader "Casey/CelShadingTerrain" 
{
	...
	SubShader{
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			half4 norm0 = tex2D(_Splat0, IN.uv_Splat0);
			half4 norm1 = tex2D(_Splat1, IN.uv_Splat0);
			half4 norm2 = tex2D(_Splat2, IN.uv_Splat0);
			half4 norm3 = tex2D(_Splat3, IN.uv_Splat0);
