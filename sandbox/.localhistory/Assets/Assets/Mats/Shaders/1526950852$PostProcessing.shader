		...
		fixed4 frag(v2f i) : SV_Target
		{
			...
			else
			{
				...
				//for (int i = 0; i < 9; i++) 
				{
					...
					result[0] = ApplyKernel3x3(KERNEL_GBLUR, t01);
					result[0] = ApplyKernel3x3(KERNEL_GBLUR, t02);

					result[0] = ApplyKernel3x3(KERNEL_GBLUR, t10);
					result[0] = ApplyKernel3x3(KERNEL_GBLUR, t11);
					result[0] = ApplyKernel3x3(KERNEL_GBLUR, t12);

					result[0] = ApplyKernel3x3(KERNEL_GBLUR, t20);
					result[0] = ApplyKernel3x3(KERNEL_GBLUR, t21);
					result[0] = ApplyKernel3x3(KERNEL_GBLUR, t22);
				}
