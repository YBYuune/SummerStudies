...
public class ThrusterEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField(t.transform.TransformDirection(t.thrustDir));
    ...
    protected virtual void OnSceneGUI()
    {
        ...
        Handles.ScaleValueHandle(1.0f, t.transform.position,  Quaternion.AngleAxis(0.0f, t.transform.TransformDirection(t.thrustDir)), size, Handles.ArrowHandleCap, 0.0f);
    }
