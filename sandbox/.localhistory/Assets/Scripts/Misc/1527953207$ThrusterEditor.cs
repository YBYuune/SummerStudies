...
public class ThrusterEditor : Editor {
    ...
    protected virtual void OnSceneGUI()
    {
        ...
        Handles.ScaleValueHandle(1.0f, t.transform.position,  Quaternion.AngleAxis(180, t.transform.TransformDirection(t.thrustDir)), size, Handles.ArrowHandleCap, 0.0f);
    }
