...
public class PlayerMovement : MonoBehaviour {
    ...
    public float movementAngleSpeed = .2;
	...
	void FixedUpdate ()
    {
        ...
        MeshTransform.localEulerAngles = new Vector3(0, 0, Mathf.LerpAngle((MeshTransform.localEulerAngles.z), -Input.GetAxis("Horizontal") * movementAngle, .5f));
