...
public class CameraController : MonoBehaviour {
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                tpos.y = Mathf.Lerp(tpos.y, PlayerTarget.position.y + Vector3.up.y, .1f);
            }
            else
            {
                tpos.y = posAtJump.y - Vector3.up.y;
            }
            transform.position = Vector3.Lerp(transform.position, tpos,.5f);
        }
