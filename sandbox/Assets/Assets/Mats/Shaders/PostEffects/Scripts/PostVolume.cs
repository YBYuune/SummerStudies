...
public class PostVolume : MonoBehaviour {
    ...
    public Color PostEffect_colorBlend_color;
    private PostProcessing_ColorBlend PostEffect_colorBlend;
    ...
    void Update()
    {
        ...
        if (isVisable)
        {
            ...
            if (usesColorBlend)
            {
                if (PostEffect_colorBlend == null)
                    PostEffect_colorBlend = Camera.main.gameObject.AddComponent<PostProcessing_ColorBlend>();
                else
                    PostEffect_colorBlend.enabled = true;

                PostEffect_colorBlend.color = PostEffect_colorBlend_color;
            }
            ...
            if (usesDistortion)
            {
                if (PostEffect_distortion == null)
                    ...
                    PostEffect_distortion.enabled = true;
            }
        ...
        else
        {
            ...
            if (PostEffect_colorBlend != null)
                PostEffect_colorBlend.enabled = false;

            if (PostEffect_distortion != null)
                PostEffect_distortion.enabled = false;
